...
const GalleryGrid: React.FunctionComponent<GalleryPictureProps> = ({
  children,
  windowWidth,
}) => {
  return (
    <div className="flex mt-4 w-full" id="Gallery">
      <div
        ...
        style={{
          display: 'grid',
          gap: '5px',
          gridTemplateColumns: `repeat(auto-fit, ${columnWidthFunction(
            windowWidth,
          )}px)`,
          gridTemplateRows: `repeat(auto-fit, ${columnWidthFunction(
            windowWidth,
          )}px)`,
          gridAutoFlow: 'dense',
        }}
