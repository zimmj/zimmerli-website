        ...
        <div className='prose max-w-none flex flex-col h-full'>
            <div className='p-5'>
                <div className='flex flex-row'>
                    ...
                    <div className='mx-1'>
                        <div className='tooltip tooltip-bottom mobile:tooltip-open' data-tip={`${picture.height} x ${picture.width}`}>
                            <div
                                className='border border-current rounded-full p-0 w-4 h-4 text-xs font-bold block'
                            >
                                i
                            </div>
                        </div>
            ...
            <div className='overflow-auto flex-auto h-20'>
                <AdvancedImage className='max-w-none m-0 h-full m-auto py-1 shadow-lg shadow-cyan-500/50' 
                cldImg={imageTag}
                 alt={picture.alt}
                 plugins={[placeholder()]}
                 />
