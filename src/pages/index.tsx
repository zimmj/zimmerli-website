        ...
        <div className="max-w-xl width-12 mx-auto">
            ...
            },
            {
              ...
              content: <>
                ...
                <p>
                  ...
                  As I started to create the backend, with the front-end in mind.
          ...
          <SimpleAccordion accordions={[{
            ...
            content:
              <div>
                <p>
                  When I was doing my apprenticeship as a chemical worker, production of pharmaceuticals.
                  I was learning about state machine ans simple logical gates.
                  With them, we needed to create simple programs to control lights or watering systems.
                </p>

                <p>
                  This showed me, that I love to solve problems, and doing it with software is a simple way.
                  From there I started to learn more about software development, and was learning java in my free time.
                </p>
              </div>
          },
          {
            title: "What is my bachelor of Life-Science-Technologies?",
            content: <>
              <p>
                It's a merger of Natur, Engineering, Medicine and Environmental science.
              </p>
              <p>
                In my studies I learned different aspect of the above mentioned topics.
                Many of them have nothing to do with software development.
                But they taught me different ways to approach problems.
                As many of the topics have logical challenges.
              </p>
            </>
          }]} />
        </div>
